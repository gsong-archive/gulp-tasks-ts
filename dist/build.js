(function (deps, factory) {
...
})(["require", "exports", "fs", "path", "run-sequence", "systemjs-builder", "gulp-load-plugins", "./clean", "./script", "./style", "./utils", "./paths", "./_gulp"], function (require, exports) {
    var fs = require("fs");
    ...
    function makeSettings(environments) {
        _gulp_1.default.task("build:make-settings", function () {
            ...
            var outfile = path.join(paths.SRC_DIR, paths.SETTINGS);
